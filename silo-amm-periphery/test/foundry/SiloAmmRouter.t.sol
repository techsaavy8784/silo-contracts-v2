...
contract SiloAmmRouterTest is Test, Fixtures, ISiloAmmRouterEvents {
    ...
    */
    function test_SiloAmmRouter_createPair_gas() public {
        ...
        emit log_named_uint("gas used", gasUsed);
        assertEq(gasUsed, 2370316, "gas usage for SiloAmmRouter.createPair");
    }
    ...
    */
    function test_SiloAmmRouter_getAmountsOut_gas() public {
        ...
        emit log_named_uint("gas used", gasUsed);
        assertEq(gasUsed, 7766, "gas usage for SiloAmmRouter.getAmountsOut");
        ...
        assertEq(gasUsed, 5368, "gas usage for SiloAmmRouter.getAmountsOut@timestamp");
