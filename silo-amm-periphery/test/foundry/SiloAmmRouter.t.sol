...
contract SiloAmmRouterTest is Test, Fixtures, ISiloAmmRouterEvents {
    ...
    */
    function test_SiloAmmRouter_createPair_gas() public {
        ...
        emit log_named_uint("gas used", gasUsed);
        assertEq(gasUsed, 2770872, "gas usage for SiloAmmRouter.createPair");
    }
    ...
    */
    function test_SiloAmmRouter_swapExactTokensForTokens_gas() public {
        ...
        emit log_named_uint("gas used", gasUsed);
        assertEq(gasUsed, 123991, "gas usage for SiloAmmRouter.swapExactTokensForTokens");
    ...
    */
    function test_SiloAmmRouter_getAmountsOut_gas() public {
        ...
        emit log_named_uint("gas used", gasUsed);
        assertEq(gasUsed, 7730, "gas usage for SiloAmmRouter.getAmountsOut");
        ...
        assertEq(gasUsed, 5310, "gas usage for SiloAmmRouter.getAmountsOut@timestamp");
    ...
    */
    function test_SiloAmmRouter_getAmountsIn_gas() public {
        ...
        emit log_named_uint("gas used", gasUsed);
        assertEq(gasUsed, 8010, "gas usage for SiloAmmRouter.getAmountsIn");
        ...
        emit log_named_uint("gas used with timestamp", gasUsed);
        assertEq(gasUsed, 5074, "gas usage for SiloAmmRouter.getAmountsIn@timestamp");
