...
library EIP712Lib {
     ...
     * contract upgrade].
     */
    function __EIP712_init(string memory name, string memory version) public {
        __EIP712_init_unchained(name, version);
    }

    function __EIP712_init_unchained(string memory name, string memory version) public {
