...
contract BorrowIntegrationTest is SiloLittleHelper, Test {
    ...
    */
    ...
    function _borrowTwoAssetsAssertions(
        ...
        uint256 maxBorrow = silo0.maxBorrow(_borrower, _sameAsset);
        ...
        maxBorrow = silo1.maxBorrow(_borrower, _sameAsset) + 1;
        ...
        uint256 gotShares = _borrow(borrowAmount, _borrower, _sameAsset);
        ...
        // in this particular scenario max borrow is underestimated by 1, so we compensate by +1, to max out
        borrowAmount = silo1.maxBorrow(_borrower, _sameAsset) + 1;
        ...
        gotShares = _borrow(borrowAmount, _borrower, _sameAsset);
        ...
        // collateral silo
        (,, _debtShareToken) = siloConfig.getShareTokens(address(_sameAsset ? silo1 : silo0));
