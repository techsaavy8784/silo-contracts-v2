...
contract MaxDepositTest is SiloLittleHelper, Test {
    ...
    */
    function test_maxDeposit_cap() public view {
    ...
    */
    ...
    /*
    forge test -vv --ffi --mt test_maxDeposit_forBorrower_1token
    */
    function test_maxDeposit_forBorrower_1token() public {
        ...
        assertEq(silo0.maxDeposit(borrower), _REAL_ASSETS_LIMIT - toBorrow * 2, "max deposit after deposit");
    ...
    */
    ...
    function test_maxDeposit_withDeposit_1token_fuzz(uint128 _initialDeposit) public {
        _maxDeposit_withDeposit(_initialDeposit);
    }

    function _maxDeposit_withDeposit(uint128 _initialDeposit) private {
    ...
    */
    ...
    function test_maxDeposit_withInterest_1token_fuzz(
        ...
        _maxDeposit_withInterest_fuzz(_initialDeposit);
    }

    function _maxDeposit_withInterest_fuzz(uint256 _initialDeposit) public {
    ...
    */
    ...
    function test_maxDeposit_repayWithInterest_1token_fuzz(
        ...
        _maxDeposit_repayWithInterest_fuzz(_initialDeposit);
    }

    function _maxDeposit_repayWithInterest_fuzz(uint64 _initialDeposit) public {
