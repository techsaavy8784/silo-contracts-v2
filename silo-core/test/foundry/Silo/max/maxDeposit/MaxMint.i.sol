...
contract MaxMintTest is SiloLittleHelper, Test {
    ...
    */
    ...
    function test_maxMint_withDeposit_1token_fuzz(uint128 _initialDeposit) public {
        _maxMint_withDeposit(_initialDeposit);
    }

    function _maxMint_withDeposit(uint128 _initialDeposit) private {
    ...
    */
    ...
    function test_maxMint_withInterest_1token_fuzz(
        ...
        _maxMint_withInterest_fuzz(_initialDeposit);
    }

    function _maxMint_withInterest_fuzz(uint256 _initialDeposit) private {
    ...
    */
    ...
    function test_maxMint_repayWithInterest_1token_fuzz(
        ...
        _maxMint_repayWithInterest(_initialDeposit);
    }

    function _maxMint_repayWithInterest(uint128 _initialDeposit) private {
