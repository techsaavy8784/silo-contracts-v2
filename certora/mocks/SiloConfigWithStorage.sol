...
contract SiloConfigWithStorage is ISiloConfig {
    ...
    address public _SILO1;

    address public _TOKEN1;

    /// @dev Token that represents a share in total protected deposits of Silo
    address public _PROTECTED_COLLATERAL_SHARE_TOKEN1;
    /// @dev Token that represents a share in total deposits of Silo
    address public _COLLATERAL_SHARE_TOKEN1;
    /// @dev Token that represents a share in total debt of Silo
    address public _DEBT_SHARE_TOKEN1;
